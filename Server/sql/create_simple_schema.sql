-- Create a small application database and simple schema for stores, products, users, reviews and orders
-- Defaults to database name 'suqwise_app' (change below if you prefer)

CREATE DATABASE IF NOT EXISTS suqwise_app CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE suqwise_app;
...
-- Orders and Order Items (store title/price/image captured at order time)
...
-- Small convenience view: product with its store and category
